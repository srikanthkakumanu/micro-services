-- Enable Vault only for Prod environment
--CREATE DATABASE IF NOT EXISTS vaultdb CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
--CREATE USER IF NOT EXISTS 'vaultadmin'@'%' IDENTIFIED BY 'vaultadmin';
--GRANT ALL PRIVILEGES ON vaultdb.* TO 'vaultadmin'@'%';
--FLUSH PRIVILEGES;
